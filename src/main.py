...
def main():
    ...
    # Realizar las operaciones de forma secuencial
    second_most_selling_df = data_processor.calculate_second_most_selling(ticket_lines_df, join_columns, group_by_columns, quantity_column, rank_column, select_columns)
